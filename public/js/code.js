...
function desencriptar() {
    ...
    if (texto != "" && !funciono) {
        ...
        encriptado = texto.replace(/ufat/g, 'u');
        encriptado = encriptado.replace(/ober/g, 'o');
        encriptado = encriptado.replace(/ai/g, 'a');
        encriptado = encriptado.replace(/imes/g, 'i');
        encriptado = encriptado.replace(/enter/g, 'e');
        

        cripto_h3.innerHTML = "Mensaje desencriptado";
        cripto_p.innerHTML = encriptado;
        not_found.style.display = "none";
        cripto.style.display = "flex";
...
function copiar(){
    navigator.clipboard.writeText(cripto_p.textContent);
    console.log(cripto_p.textContent);
}
